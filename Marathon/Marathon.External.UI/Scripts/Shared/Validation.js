Marathon.Shared.Validation = function () {

    var initializeValidationErrorLinks = function () {

        $('.validation-error-link').unbind("click");
    ...
    var initializeValidation = function () {
        //Scroll to top of validation summary after client side validation.
...
$(document).ready(function () {
    Marathon.Shared.Validation.initialize();
});