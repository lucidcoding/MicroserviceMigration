[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Marathon.UI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Marathon.UI.App_Start.NinjectWebCommon), "Stop")]

namespace Marathon.UI.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ICollectDetailsViewModelMapper>().To<CollectDetailsViewModelMapper>();
